...
public:
	ItemData()
		: arrpsz( NULL ), dwData( NULL ),crText ( NULL ),crBak (NULL)
	{
	}
...
BOOL CSortListCtrl::SetHeadings(UINT uiStringID, int nFormat /* = LVCFMT_LEFT  */)
{
	CString strHeadings;
...
BOOL CSortListCtrl::SetHeadings(const CString& strHeadings, int nFormat /* = LVCFMT_LEFT  */)
{
	int iStart = 0;
	
//	if( LVS_EX_CHECKBOXES == (GetExtendedStyle() & LVS_EX_CHECKBOXES) )
//	{
//		if ( -1 == InsertColumn( m_iNumColumns++, "选择", nFormat, 36 ) )
//			return FALSE;		
//	}
